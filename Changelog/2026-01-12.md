...
Set up a GitHub Action workflow to automate the release of the macOS app. The workflow builds the app using ad-hoc signing (for technical audiences), packages it into a DMG file, and creates a GitHub release.
